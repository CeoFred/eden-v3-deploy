...
export const initReservesByHelper = async (
  ...
  for (let i = 0; i < reserveSymbols.length; i++) {
    ...
    initInputParams.push({
      ...
      aTokenName: `Eden ${aTokenNamePrefix} ${reserveSymbols[i]}`,
      aTokenSymbol: `e${symbolPrefix}${reserveSymbols[i]}`,
      variableDebtTokenName: `Eden ${variableDebtTokenNamePrefix} Variable Debt ${reserveSymbols[i]}`,
      variableDebtTokenSymbol: `variableDebt${symbolPrefix}${reserveSymbols[i]}`,
      stableDebtTokenName: `Eden ${stableDebtTokenNamePrefix} Stable Debt ${reserveSymbols[i]}`,
